...
@Component({
  selector: 'app-formulario-programacion-243',
  imports: [CommonModule],
  templateUrl: './formulario-programacion-243.html',
  styleUrl: './formulario-programacion-243.css',
})
export class FormularioProgramacion243 {
  ...
  crearFilaVacia(): Fila {
    ...
    return {
      ...
      cliente: '',
      semana: 0,
      departamento: 'PESPUNTE 243 LEÓN',
      linea: '',
      dia: '',
  ...
  addProgramacionPespunte243() {
    ...
    this.programacionService.postProgramacion(todasLasFilas).subscribe({
      next: (response) => {
        console.log('Programación de Pespunte 243 León guardada con éxito', response);
