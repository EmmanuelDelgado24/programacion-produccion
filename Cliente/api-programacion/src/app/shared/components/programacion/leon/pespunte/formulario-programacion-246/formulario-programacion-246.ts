...
@Component({
  selector: 'app-formulario-programacion-246',
  imports: [CommonModule],
  templateUrl: './formulario-programacion-246.html',
  styleUrl: './formulario-programacion-246.css',
})
export class FormularioProgramacion246 {
  ...
  crearFilaVacia(): Fila {
    ...
    return {
      ...
      cliente: '',
      semana: 0,
      departamento: 'PESPUNTE 246 LEÓN',
      linea: '',
      dia: '',
  ...
  addProgramacionPespunte246() {
    ...
    this.programacionService.postProgramacion(todasLasFilas).subscribe({
      next: (response) => {
        console.log('Programación de Pespunte 246 León guardada con éxito', response);
