...
@Component({
  selector: 'app-formulario-montado2-md',
  imports: [CommonModule],
  templateUrl: './formulario-montado2-md.html',
  styleUrl: './formulario-montado2-md.css',
})
export class FormularioMontado2Md {
  ...
  crearFilaVacia(): Fila {
    ...
    return {
      ...
      cliente: '',
      semana: 0,
      departamento: 'MONTADO/ADORNO 2 MD',
      linea: '',
      dia: '',
  ...
  addProgramacionMontado2() {
    ...
    this.programacionService.postProgramacion(todasLasFilas).subscribe({
      next: (response) => {
        console.log('Programación de Montado/Adorno 2 MD guardada con éxito', response);
